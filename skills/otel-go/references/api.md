...
The Logs API and SDK are versioned on a **separate v0.x line** (snapshot verified 2026-08-04:
`otel/log` and `otel/sdk/log` v0.21.0, released alongside core v1.45.0) and are **Beta** — interfaces may
...
attribute.KeyValue     // Log attribute (v0.21.0+)
